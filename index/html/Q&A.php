        ...
        <div class="inner">
         ...
         if(isset($_GET['page'])){
          $page = $_GET['page'];
              ...
              $sql2 = mq("select * from qna order by idx desc limit $start_num, $list");  
              ...
              ?>
                        <tr>
                            ...
                            <td class="board_list_title">
                                <li class="list_li"></li>
                                <?php
                            echo "<a href='./qna/qna_view.php?idx=".$board["idx"]."'>";
                            echo $board["title"];
                            echo "</a>";
                        ?>
                            </td>
            ...
            ?>
                ...
                <div class="search_box">
                    <form class="search_form" action="./notice board_result.php" method="get">
                        ...
                        <input type="text" name="search" size="40" required="required" /> <button
