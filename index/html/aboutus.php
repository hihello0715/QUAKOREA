...
<head>
  ...
  <link rel="stylesheet" media="all and (max-width: 640px)" href="../css/mobile/aboutm.css">
  ...
  <nav>
    ...
    <div class="right">
      <div class="link">
        ...
        <a href="../en/aboutus_en.html">EN</a>
        <a href="../jp/aboutus_jp.html">JP</a>
      </div>
...
<body>
  <sectionc class="sec1">
    ...
    <div class="inner">
      <div class="content1">
        <h2>쿠아코리아는<br>즐거운 물생활을 응원하는<br>수족관 관련 제품 업체입니다.</h2>
        <div class="wave-box">
        ...
        <div class="text_one">
          <p>수중 생태계와 인위적 공간을 이어주는 제품을 만들고자 했던 신념과 고집을 버리겠습니다. </p>
          <p>수중 생물의 입장이 되어 더욱 <span>친환경적 제품을 만들겠습니다.</span></p>
          <p>고객의 입장이 되어 더욱 편리하고 <span>실용적인 제품을 만들겠습니다.</span></p>
          <p>쿠아코리아는 원점으로 돌아가 <span>새롭게 시작하겠습니다.</span></p>
        </div>
      </div>
      <div class="content2">
        <h2><span>어제보다 더 행복한 오늘, </span><span>오늘보다 더 밝은 내일</span></h2>
        <h2>내일보다 더 오래도록 함께하는 쿠아코리아가 되겠습니다.</h2>
        <div class="map">
        ...
        <p>쿠아가 이룩한 성장의 바탕에는 <span>“한 우물 파기” 쿠아정신이 자리하고 있습니다.</span></p>
        <p>이를 바탕으로 도전, 열정, 정도의 <span>핵심가치를 선정하고</span></p>
        <p>이를 임직원의 생각과 행동의 기준으로 삼아 <span>쿠아人으로서의 일체감을 강화하고 있습니다.</span></p>
        <p>핵심가치는 비전 달성을 위한 수족관 기업문화 혁신의 원동력입니다. </p>
      </div>
    </div>
  </sectionc>
