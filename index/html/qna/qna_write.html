...
<body>
    <sectionc class="sec1">
        ...
        <div class="inner">
            ...
            <div class="board_write_title">질문하기</div>
                <form action="qna_write_ok.php" method="post">
                    <div class="board_write_title_textarea_wrapper">
                      <div class="board_write_subtitle_wrapper"><div class="board_write_subtitle">제목</div></div>
                        <textarea name="title" class="board_write_title_textarea" rows="1" cols="55" minlength="2" maxlength="100" required></textarea>
                    </div>
                    <div class="board_write_title_textarea_wrapper">
                      <div class="board_write_subtitle_wrapper"><div class="board_write_subtitle">작성자</div></div>
                        <textarea name="name" class="board_write_nametitle_textarea" rows="1" cols="55" minlength="2" maxlength="4" required></textarea>
                    </div>
                    <div class="board_write_content_textarea_wrapper">
                        <textarea name="content" class="board_write_contenttitle_textarea" rows="1" cols="55"  required></textarea>
                    </div>
